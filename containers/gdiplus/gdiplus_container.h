...
protected:
	...
	void	draw_ellipse(HDC hdc, point p, size sz, litehtml::web_color color, int line_width) override;
	void	fill_ellipse(HDC hdc, point p, size sz, litehtml::web_color color) override;
	void	fill_rect(HDC hdc, point p, size sz, litehtml::web_color color) override;
