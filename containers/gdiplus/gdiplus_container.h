...
protected:
	...
	void	draw_ellipse(HDC hdc, litehtml::point p, litehtml::size sz, litehtml::web_color color, int line_width) override;
	void	fill_ellipse(HDC hdc, litehtml::point p, litehtml::size sz, litehtml::web_color color) override;
	void	fill_rect(HDC hdc, litehtml::point p, litehtml::size sz, litehtml::web_color color) override;
