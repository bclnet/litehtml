...
namespace litehtml
{
    ...
    protected:
		...
		virtual int _render(point p, const containing_block_context& containing_block_size, formatting_context* fmt_ctx, bool second_pass = false)
		{
			return 0;
		}
    ...
    public:
		...
		int render(point p, const containing_block_context& containing_block_size, formatting_context* fmt_ctx, bool second_pass = false);
